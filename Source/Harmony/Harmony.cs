...
namespace Ammunition.Harmony {
    ...
    internal static class Harmony {
        ...
        public static void GeneratePawn_PostFix(Pawn __result) {
            if (__result != null && __result.equipment != null && __result.equipment.Primary != null && !Settings.SettingsHelper.LatestVersion.Excluded.Contains(__result.equipment.Primary.def.defName)) {
